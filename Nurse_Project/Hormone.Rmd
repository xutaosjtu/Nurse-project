...
pdf("TEMP/metabolite concentration at different time sections of the day.pdf", width = 30, height = 20)
...
#   p = p + facet_grid(shift~.)
  ...
  p = p + facet_grid(shift+Kontrolle~. )
...
metabo$m = metabo[,i]
p = ggplot(subset(metabo, SW_Nr %in% c("SW1030")), aes(hour, m), subset())
...
pdf("TEMP/hormone levels comparing day and night shift_both group.pdf", width = 30, height = 20)
k=1;nrow=1;ncol=1;newp=F
pushViewport(viewport(layout = grid.layout(3, 3)))
